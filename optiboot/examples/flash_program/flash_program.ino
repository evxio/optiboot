 ...
 * bootloader to write FLASH memory by application code
 *
 * IMPORTANT THINGS:
 ...
 * - only working sequence is erase-fill-write
 *
 ...
 *
 * WRITE SEQUENCE - option 2 (doesn't work with current Optiboot entry)
